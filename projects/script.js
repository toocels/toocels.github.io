var projects = [{
	...
	img: "./proofs/minecraft-server-finder.png"
}, {
	...
	img: "./proofs/online-multiplayer.png"
}, {
	...
	img: "./proofs/self-balancing-robot-2.jpg"
}, {
	head: "Twitter bot",
	...
	img: "./proofs/flappy-bird-terminal.png"
}, {
	...
	img: "./proofs/gesture-detection.jpg"
},
{
	head: "E-Cell website",
	text: "So bascially for my college club ecell by me and another club memeber. This was mostly css work, and only technical stuff was sending email for kyc, and signing up to newsleteers. First kinda irl application making",
	img: "./proofs/ecell.png"
},
{
	head: "Daksh website",
	text: "Actualy proper good backend work i had here. Had to verify transactions, admins can edit their program, and all dynamically loaded and stored in mongodb and hosted by nextjs. A veryy good irl prodution code. Feels like my first irl alcual ppl affecting project.",
	img: "./proofs/daksh.png"
}]
